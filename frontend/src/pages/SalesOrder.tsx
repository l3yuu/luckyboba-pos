            ...
            <div className="bg-white w-full max-w-lg rounded-[2rem] shadow-2xl flex flex-col h-[80vh] animate-in zoom-in-95 duration-200">
              <div className="bg-[#3b2063] p-6 text-white text-center relative shrink-0 rounded-t-[2rem]">
                ...
                <button 
                  ...
                  className="absolute top-6 right-6 text-white/70 hover:text-white font-bold text-xs bg-white/20 px-3 py-1.5 rounded-lg transition-colors uppercase tracking-wider"
                >
                  Done
                </button>
              </div>
                  ...
                  {AddOnsList.map((addon) => (
                    <button
                      ...
                      className={`p-3 rounded-xl text-left border-2 transition-all h-24 flex flex-col justify-between ${
                        ...
                        ? 'bg-[#3b2063] border-[#3b2063] text-white shadow-lg scale-[1.02]'
                        : 'bg-white border-zinc-100 text-zinc-500 hover:border-[#3b2063]/30 hover:bg-zinc-50'
                      }`}
                    >
                      <span className="text-[10px] font-black uppercase leading-tight line-clamp-2">{addon.name}</span>
              ...
              <div className="p-4 border-t border-zinc-100 bg-zinc-50 rounded-b-[2rem]">
                <button 
                  onClick={() => setIsAddOnModalOpen(false)}
                  className="w-full bg-[#3b2063] text-white py-4 rounded-xl font-black uppercase tracking-widest shadow-lg hover:bg-[#2a1647] transition-all"
                >
