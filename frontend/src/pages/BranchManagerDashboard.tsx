      ...
      {isConfirmModalOpen && selectedUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-2 sm:p-4 animate-in fade-in duration-200">
          <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            {/* FIXED: Active user = red (deactivating), Inactive user = green (activating) */}
            ...
            <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
              <div className="text-center space-y-2">
                {/* FIXED: Active user = red circle with X (deactivate warning), Inactive = green circle with check (activate) */}
                ...
                {/* FIXED: Title reflects the action being taken */}
              ...
              <div className="flex gap-2 sm:gap-3 pt-2">
                {/* FIXED: Button color and label match the action */}
                <button 
