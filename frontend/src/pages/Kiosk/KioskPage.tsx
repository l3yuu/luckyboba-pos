              ...
              <div className="p-6 border-b border-zinc-100 bg-white flex items-center justify-between shrink-0 shadow-sm z-10">
                <div className="flex items-center gap-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl flex items-center justify-center shadow-inner">
                    <ShoppingBag size={32} className="text-[#6a12b8]" />
                  </div>
                  <div>
                    <div className="relative">
              ...
              <div className="p-6 border-t border-zinc-100 bg-white flex items-center justify-between shrink-0 shadow-[0_-10px_30px_rgba(0,0,0,0.02)] z-10">
                ...
                {mixMatchStep === 'customize_drink' && (
                  <button
                    ...
                    className="bg-gradient-to-r from-[#6a12b8] to-purple-500 text-white px-12 py-5 rounded-xl font-black uppercase tracking-wider text-xl flex items-center gap-4 hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-purple-200"
                  >
                    {t.addToTray}
                ...
                <div className="flex items-center gap-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl overflow-hidden border border-orange-100 flex items-center justify-center shadow-inner">
                    {customizingItem.image ? (
                      ...
                      <ShoppingBag size={40} className="text-[#6a12b8]" />
                    )}
                  </div>
                  <div>
                    <h3 className="text-xl font-black text-zinc-900 tracking-tight uppercase line-clamp-1">{customizingItem.name}</h3>
                    <div className="inline-block px-2 py-0.5 bg-purple-50 border border-purple-200 text-[#6a12b8] rounded-md text-xs font-bold uppercase tracking-widest mt-1">{customizingItem.category}</div>
                  </div>
                </div>
                <button
                  ...
                  customizingItem.category?.toLowerCase().includes('milktea')) && sugarLevels.length > 0 && (
                    <div className="bg-white/95 p-5 rounded-2xl border border-purple-100 shadow-sm">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-8 h-8 bg-gradient-to-r from-[#6a12b8] to-purple-500 text-white rounded-full flex items-center justify-center font-black text-sm shrink-0">1</div>
                        ...
                        {sugarLevels.map((sl) => (
                          <button
                            ...
                            className={`py-3 rounded-xl font-bold text-sm transition-all border-2 ${selectedSugarLevel === sl.value
                              ? 'bg-gradient-to-r from-[#6a12b8] to-purple-500 border-[#6a12b8] text-white scale-105 shadow-[0_8px_16px_rgba(124,20,212,0.3)]'
        ...
        <div className="max-w-5xl mx-auto w-full flex flex-col h-full relative z-10">
          ...
          <div className="flex flex-col items-center mb-12 shrink-0 animate-in fade-in slide-in-from-top-6 duration-1000">
            ...
            <h1 className="text-5xl font-black text-zinc-900 tracking-tighter text-center" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
              Kiosk <span className="text-[#6a12b8] italic">Setup</span>
            </h1>
          ...
          <div className="mb-12 shrink-0 w-full max-w-2xl mx-auto animate-in fade-in slide-in-from-top-4 duration-1000 delay-200">
            <div className="relative group">
              <div className="absolute inset-y-0 left-6 flex items-center pointer-events-none">
                <Search size={22} className="text-zinc-300 group-focus-within:text-[#6a12b8] transition-colors duration-300" />
              </div>
              <input
                value={branchSearch}
            ...
            {filtered.map(branch => (
              <button
                ...
                className={`p-10 rounded-[2.5rem] border-2 flex flex-col items-start text-left transition-all duration-500 group active:scale-[0.97] backdrop-blur-xl group relative ${selectedBranchToConfirm?.id === branch.id
                  ? 'bg-white border-[#6a12b8] shadow-[0_25px_60px_rgba(124,20,212,0.15)] -translate-y-2'
              ...
              >
                ...
                <div className="flex items-center gap-6 w-full mb-6 relative z-10">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center shrink-0 transition-all duration-500 border ${selectedBranchToConfirm?.id === branch.id
                    ? 'bg-gradient-to-br from-[#6a12b8] to-fuchsia-600 border-[#6a12b8] text-white shadow-lg shadow-purple-200 scale-110'
                    : 'bg-white border-zinc-100 text-zinc-400 group-hover:bg-gradient-to-br group-hover:from-[#6a12b8] group-hover:to-fuchsia-600 group-hover:border-[#6a12b8] group-hover:text-white group-hover:scale-110'
                    }`}>
                    <ShoppingBag size={28} />
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {selectedBranchToConfirm?.id === branch.id && (
                        <div className="px-3 py-1 bg-gradient-to-br from-[#6a12b8] to-fuchsia-600 text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm">
                          {t.selected}
                        </div>
                      )}
                    </div>
                ...
                <div className="mt-8 pt-6 border-t border-zinc-100/50 w-full flex items-center justify-between relative z-10">
                  <div className={`flex items-center gap-2 font-black uppercase text-[10px] tracking-[0.2em] transition-all duration-500 ${selectedBranchToConfirm?.id === branch.id
                    ? 'text-[#6a12b8] translate-x-1'
                    : 'text-zinc-300 group-hover:text-[#6a12b8] group-hover:translate-x-1'
                    }`}>
      ...
      {isAdminModalOpen && (
        <div className="absolute inset-0 bg-zinc-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-6 text-center print:hidden animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl p-10 max-w-2xl w-full max-h-[90vh] overflow-hidden shadow-2xl flex flex-col items-center border border-zinc-100">
            <h2 className="text-3xl font-black text-[#6a12b8] uppercase italic mb-8 shrink-0">{t.adminSettings}</h2>
                    ...
                    <div className="flex flex-col gap-3 mb-2">
                      ...
                      <div className="flex gap-2 overflow-x-auto pb-2">
                        <button
                          ...
                          className={`px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-colors whitespace-nowrap shrink-0 ${expoCategoryFilter === '' ? 'bg-[#6a12b8] text-white shadow-md' : 'bg-zinc-100 text-zinc-500 hover:bg-zinc-200'}`}
                        >
                          {t.all}
                        </button>
                        {Array.from(new Set(items.map(i => i.category))).filter(Boolean).map(cat => (
                          <button
                            ...
                            className={`px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-colors whitespace-nowrap shrink-0 ${expoCategoryFilter === cat ? 'bg-[#6a12b8] text-white shadow-md' : 'bg-zinc-100 text-zinc-500 hover:bg-zinc-200'}`}
                          >
                            {cat}
                          </button>
                        ))}
            ...
            <button
              ...
              className="mt-8 py-5 bg-[#6a12b8] hover:bg-[#2d184d] text-white rounded-2xl font-black uppercase tracking-[0.2em] text-sm shadow-xl shadow-[#6a12b8]/20 w-full shrink-0"
            >
              {t.closeSettings}
            </button>
          </div>
