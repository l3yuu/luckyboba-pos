...
const STYLES = `
  ...
  .sa-tab.active { background: #a020f010; color: #a020f0; font-weight: 600; }
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <p className="text-[0.52rem] font-black uppercase tracking-[0.15em] text-[#a020f0]/70">
                  Console Active
                </p>
              </div>
            </div>
                ...
                {group.items.map((item) => (
                  <button
                    ...
                    className={`sa-tab flex items-center gap-2.5 w-full px-2.5 py-1.5 text-[0.8rem] font-medium text-left relative transition-all ${
                      currentTab === item.id ? 'active text-[#a020f0]' : 'text-zinc-500 hover:bg-[#a020f005] hover:text-[#a020f0]'
                    }`}
                  >
                    <div className={`shrink-0 w-8 h-8 rounded-[0.45rem] flex items-center justify-center transition-colors ${
                      currentTab === item.id ? 'bg-[#a020f020]' : 'bg-[#f8f9fa]'
                    }`}>
                      {item.icon}
                    </div>
                    {item.label}
