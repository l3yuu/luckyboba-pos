        ...
        return (
          <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f6ff] p-6">
            <div className="bg-white rounded-4xl shadow-xl border border-red-100 p-10 max-w-md w-full text-center space-y-4">
              ...
              <h2 className="text-[#a020f0] font-black uppercase text-lg tracking-tight">Persistent Error Detected</h2>
              ...
              <button
                ...
                className="w-full py-3 bg-[#a020f0] text-white rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-[#2a1647] transition-all"
              >
                Reload Page
              </button>
            </div>
