            ...
            <div className="flex-1 overflow-y-auto p-8 w-full scroll-smooth">
              ...
              <div className="w-full border-t border-zinc-100 pt-6 px-4 space-y-6">
                <div className="flex items-center justify-between bg-[#f8f6ff] p-4 rounded-2xl border border-zinc-200">
                   <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Total Count :</span>
                ...
                {!latestTx ? (
                  ...
                  <button onClick={handleNewCount} className="w-full bg-zinc-100 hover:bg-zinc-200 text-zinc-600 py-5 rounded-3xl font-black text-sm uppercase tracking-[0.25em] transition-all duration-200">
                    New Count
                  </button>
                )}
              </div>
