      ...
      <div className="bg-white border border-zinc-200 rounded-[0.625rem] p-5 shadow-sm flex flex-wrap gap-4 items-end">
        <div className="flex-1 min-w-[240px]">
          ...
          <div className="relative group">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-400 pointer-events-none group-focus-within:text-[#a020f0] transition-colors" size={16} />
            <input
              type="text"
              value={searchQuery}
              onChange={e => setSearchQuery(e.target.value)}
              placeholder="Search SI number, customer, etc..."
              className="w-full bg-zinc-50 border border-zinc-200 rounded-lg pl-10 pr-10 py-2.5 text-sm font-semibold text-[#1a0f2e] outline-none focus:ring-2 focus:ring-violet-400/20 focus:border-[#a020f0] transition-all"
            />
            {searchQuery && (
        ...
        <div className="w-full sm:w-auto">
          <div className="flex justify-between items-center mb-1.5">
            ...
            <button 
              ...
              className="text-[9px] font-black text-[#a020f0] uppercase tracking-wider hover:underline"
            >
        ...
        <button
          ...
          disabled={isLoading}
          className="bg-[#a020f0] hover:bg-[#2a1647] text-white px-8 py-2.5 rounded-lg font-bold text-sm uppercase tracking-widest transition-all active:scale-[0.98] disabled:opacity-50 flex items-center gap-2"
        >
        ...
        <div className="px-6 py-4 border-b border-zinc-100 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-violet-50 p-2 rounded-lg">
              <Terminal size={16} className="text-[#a020f0]" />
            </div>
            <div>
            ...
            <tbody className="divide-y divide-zinc-50">
              ...
              {!isLoading && searchResults.map(item => (
                <tr key={item.sale_id} className="hover:bg-zinc-50/80 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="inline-flex items-center gap-1.5 px-2 py-1 bg-[#a020f0]/5 border border-[#a020f0]/10 rounded-md">
                      <span className="text-[10px] font-black text-[#a020f0] uppercase tracking-wider">{item.branch_name}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center bg-white border border-zinc-200 text-zinc-400 hover:text-[#a020f0] hover:border-[#a020f0] hover:bg-violet-50 transition-all rounded-lg shadow-sm"
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-zinc-100">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 bg-[#f5f0ff] border border-[#e9d5ff] rounded-lg flex items-center justify-center">
                  <Printer size={16} className="text-[#a020f0]" />
                </div>
                <div>
                    ...
                    <button
                      ...
                      className={`w-full p-4 rounded-xl font-black text-[10px] uppercase tracking-[0.1em] transition-all flex items-center justify-between border-2
                        ${isActive
                          ...
                          : 'bg-white border-zinc-100 text-zinc-600 hover:border-[#a020f0] hover:text-[#a020f0] hover:bg-violet-50'
