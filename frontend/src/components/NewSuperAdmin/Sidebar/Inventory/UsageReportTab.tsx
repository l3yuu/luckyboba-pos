        ...
        <div className="flex-1 w-full bg-white border border-zinc-200 rounded-[0.625rem] overflow-hidden shadow-sm">
          <div className="flex flex-wrap items-center gap-3 px-5 py-4 border-b border-zinc-100">
            ...
            <button onClick={handleExport} disabled={exporting || loading}
              className="bg-[#3b2063] hover:bg-[#2d1851] shrink-0 text-white px-4 py-2 h-9 rounded-lg font-bold text-xs uppercase tracking-widest flex items-center gap-1.5 transition-all disabled:opacity-50">
