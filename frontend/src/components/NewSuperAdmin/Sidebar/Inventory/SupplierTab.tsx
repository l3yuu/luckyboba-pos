      ...
      <div className="relative bg-white w-full max-w-lg border border-zinc-200 rounded-[1.25rem] shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-zinc-100 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-[#f5f0ff] border border-[#e9d5ff] rounded-lg flex items-center justify-center">
              <Building2 size={15} className="text-[#7c14d4]" />
            </div>
            <div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 flex flex-col gap-4">
          ...
          <label className="flex items-center gap-3 p-3 bg-zinc-50 border border-zinc-200 rounded-xl cursor-pointer hover:bg-[#faf9ff] transition-colors">
            <div className={`w-10 h-6 rounded-full transition-colors flex items-center ${form.is_active ? 'bg-[#7c14d4]' : 'bg-zinc-300'}`}
          ...
          <div>
            <label className="text-[10px] font-bold uppercase tracking-wider text-zinc-400 mb-1.5 block">
              ...
              {form.material_ids.length > 0 && (
                <span className="ml-2 text-[9px] font-black text-[#7c14d4] bg-[#f5f0ff] px-1.5 py-0.5 rounded border border-[#e9d5ff]">
                ...
                {filteredMats.length === 0 ? (
                  ...
                  return (
                    <label key={m.id}
                      ...
                      <div className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-all ${checked ? 'bg-[#7c14d4] border-[#7c14d4]' : 'border-zinc-300'}`}
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-zinc-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#f5f0ff] border border-[#e9d5ff] rounded-xl flex items-center justify-center">
              <Building2 size={18} className="text-[#7c14d4]" />
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {supplier.materials.map(m => (
                  <span key={m.id} className="text-[10px] font-semibold bg-[#f5f0ff] text-[#7c14d4] border border-[#e9d5ff] px-2 py-0.5 rounded-full">
                    {m.name}
                  </span>
                ))}
              </div>
  ...
  return (
    <div className="p-6 md:p-8 bg-[#f4f2fb] min-h-full">
      ...
      <div className="grid grid-cols-3 gap-4 mb-5">
        {[
          { label: 'Total Suppliers', value: suppliers.length,                    color: '#7c14d4', bg: '#f5f0ff', border: '#e9d5ff' },
            ...
            <tbody>
              ...
              {!loading && filtered.map(s => (
                <tr key={s.id} className="border-b border-zinc-50 hover:bg-[#faf9ff] transition-colors">
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 bg-[#f5f0ff] border border-[#e9d5ff] rounded-lg flex items-center justify-center shrink-0">
                        <Building2 size={14} className="text-[#7c14d4]" />
                      </div>
                      <div>
                  ...
                  <td className="px-5 py-3.5">
                    <span className="text-xs font-bold text-[#7c14d4] bg-[#f5f0ff] px-2 py-0.5 rounded border border-[#e9d5ff]">
