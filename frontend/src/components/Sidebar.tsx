...
interface SidebarProps {
  ...
  isBranchManager?: boolean; // Add prop to differentiate branch manager view
}
...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  // Branch Manager View - simplified navigation
  if (isBranchManager) {
    return (
      <>
        <aside className={`
        ...
        <div className="flex flex-col flex-1 overflow-y-auto no-scrollbar">
          ...
          <nav className="w-full px-6 space-y-2 pb-6">
            ...
            <div className="w-full">
              ...
              <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isInventoryDropdownOpen ? 'max-h-[500px] opacity-100 mt-2' : 'max-h-0 opacity-0'}`}>
                <div className="flex flex-col space-y-1 pl-4 border-l-2 border-[#f0ebff] ml-5">
