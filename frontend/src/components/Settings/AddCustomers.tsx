...
const AddCustomers = ({ onBack }: AddCustomersProps) => {
  ...
  return (
    <>
      {activeTab === 'REPORT' ? (
        <CustomerReport onBack={onBack} activeTab={activeTab} setActiveTab={setActiveTab} />
      ) : (
          ...
          <div className="flex justify-end">
            <div className="flex gap-2">
              <button
                ...
                className="px-6 py-2 rounded-lg font-black text-[10px] uppercase tracking-widest transition-all bg-[#2a9d8f] text-white shadow-md"
              >
                Customer
              </button>
              <button
                onClick={() => setActiveTab('REPORT')}
                className="px-6 py-2 rounded-lg font-black text-[10px] uppercase tracking-widest transition-all bg-white text-zinc-400 border border-zinc-200"
              >
                Report
              </button>
            </div>
