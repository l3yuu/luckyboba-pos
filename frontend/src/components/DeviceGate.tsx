      ...
      <div className="h-screen flex items-center justify-center bg-gray-50 p-6">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center space-y-4">
          ...
          <button
            onClick={handleCopy}
            disabled={!deviceId}
            className="w-full py-2 px-4 bg-[#3b2063] text-white text-sm font-semibold rounded-lg hover:bg-[#2d1850] transition-colors disabled:opacity-40 flex items-center justify-center gap-2"
          >
            {copied ? (
              <>
