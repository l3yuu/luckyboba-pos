        ...
        <div className="bg-white p-6 rounded-4xl shadow-sm border border-zinc-100 mb-6 print:hidden">
          <div className="flex flex-col xl:flex-row gap-4 items-end">
            ...
            <div className="w-full xl:w-auto">
              <button className="w-full xl:w-40 p-3 bg-[#3b2063] text-white rounded-xl font-black uppercase text-xs tracking-widest hover:bg-[#2a1647] transition-all shadow-lg shadow-purple-900/20 active:scale-95 h-12.5">
                Generate
              </button>
            </div>
            ...
            <div className="w-full xl:w-auto">
              <button 
                onClick={handlePrint}
                className="w-full xl:w-40 p-3 bg-[#3b2063] text-white rounded-xl font-black uppercase text-xs tracking-widest hover:bg-[#2a1647] transition-all shadow-lg shadow-purple-900/20 active:scale-95 h-12.5 flex items-center justify-center gap-2"
              >
