...
const DevicePill: React.FC<{ deviceNumber?: string | null }> = ({ deviceNumber }) =>
  deviceNumber ? (
    <span className="inline-flex items-center gap-1 text-[10px] font-bold bg-[#a020f0]08 text-[#a020f0] border border-[#a020f0]20 px-2 py-0.5 rounded-full">
        ...
        <div className={`relative bg-white w-full ${maxWidth} border border-slate-200 rounded-[1.25rem] shadow-2xl overflow-hidden`}>
          <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/30">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 bg-[#a020f0]08 border border-[#a020f0]15 rounded-xl flex items-center justify-center text-[#a020f0]">{icon}</div>
              <div>
...
const inputCls = (err?: string) =>
  `w-full text-sm font-bold text-slate-700 bg-slate-50 border rounded-lg px-4 py-2.5 outline-none focus:ring-2 focus:ring-[#a020f0]/10 focus:border-[#a020f0] focus:bg-white transition-all ${err ? 'border-rose-300 bg-rose-50' : 'border-slate-200'}`;
    ...
    <div className="tl-staff-hub p-8 md:p-12">
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
        <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-100 bg-slate-50/50">
          <div className="flex-1 flex items-center gap-2 bg-white border border-slate-200 rounded-lg px-4 py-2.5 shadow-sm transition-all focus-within:border-[#a020f0] focus-within:ring-1 focus-within:ring-[#a020f0]/10">
                ...
                <tr key={u.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${u.role === 'team_leader'
                      ? 'bg-[#a020f0]08 text-[#a020f0] border border-[#a020f0]20'
                      : 'bg-slate-100 text-slate-500 border border-slate-200'
                      }`}>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-all duration-200 translate-x-2 group-hover:translate-x-0">
                      <button onClick={() => setViewTarget(u)}
                        className="p-1.5 hover:bg-slate-100 rounded-lg text-slate-400 hover:text-[#a020f0] transition-colors" title="View">
                        <Eye size={14} />
                      </button>
                      <button onClick={() => setEditTarget(u)}
                        className="p-1.5 hover:bg-slate-100 rounded-lg text-slate-400 hover:text-[#a020f0] transition-colors" title="Edit">
                        <Edit2 size={14} />
                      </button>
                      ...
                      <button
                        ...
                        className={`p-1.5 rounded-lg transition-colors ${u.device_number
                          ? 'hover:bg-slate-100 text-[#a020f0] hover:text-[#2a1647]'
