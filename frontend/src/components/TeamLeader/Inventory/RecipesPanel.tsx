            ...
            <div key={r.id} className="tl-card border-slate-200 hover:border-slate-300 transition-all">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-[#a020f010] group-hover:text-[#a020f0] transition-colors">
                    <FlaskConical size={18} />
                  </div>
                  <div>
                    <h3 className="text-[13px] font-black text-slate-900 leading-tight flex items-center gap-2">
                      {name}
                      <span className="text-[9px] font-black uppercase bg-[#a020f010] text-[#a020f0] px-1.5 py-0.5 rounded leading-none border border-[#a020f010]">
                        {sizeLabel(r.size)}
                      </span>
                    </h3>
                ...
                <div className="text-slate-300 group-hover:text-[#a020f0] transition-colors">
