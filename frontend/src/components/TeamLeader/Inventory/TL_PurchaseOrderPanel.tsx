      ...
      <div className="bg-white border border-zinc-200 rounded-[0.625rem] overflow-hidden flex flex-col shadow-sm">
        <div className="px-6 py-4 border-b border-zinc-100 flex flex-wrap items-center gap-4">
          ...
          <button
            ...
            className="h-10 px-5 bg-[#6a12b8] hover:bg-[#2a1647] text-white font-bold text-xs uppercase tracking-widest transition-all rounded-lg shadow-sm flex items-center gap-2 whitespace-nowrap"
          >
                ...
                filteredOrders.map((po) => (
                  <tr key={po.id} className="hover:bg-[#faf9ff] transition-colors">
                    <td className="px-6 py-4">
                      <span className="text-xs font-black text-[#6a12b8] font-mono">{po.poNumber}</span>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-center">
                      <button
                        ...
                        className="h-8 w-8 inline-flex items-center justify-center bg-white border border-zinc-200 hover:border-[#6a12b8] hover:text-[#6a12b8] text-zinc-400 transition-all rounded-lg shadow-sm"
                      >
                        <FileText size={14} />
                      </button>
                    </td>
            ...
            <form onSubmit={handleCreatePO} className="flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-zinc-200 bg-zinc-50 text-sm font-bold outline-none transition-all placeholder:text-zinc-300 focus:border-[#6a12b8] focus:bg-white"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-zinc-200 bg-zinc-50 text-sm font-bold outline-none transition-all focus:border-[#6a12b8] focus:bg-white cursor-pointer"
                    />
                  </div>
                </div>
                ...
                <div className="border border-zinc-200 rounded-2xl p-4 bg-zinc-50/50">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button 
                      type="button" 
                      onClick={addFormItem} 
                      className="text-[#6a12b8] font-black text-[10px] uppercase tracking-widest flex items-center gap-1.5 px-3 py-1.5 bg-white border border-[#e9d5ff] rounded-lg hover:bg-[#f5f0ff] transition-all shadow-sm"
                    >
                    ...
                    {formItems.map((item, index) => (
                      <div key={index} className="flex gap-2 items-center group">
                        <select
                          ...
                          className="flex-1 bg-white border border-zinc-200 rounded-lg px-3 py-2 text-xs font-bold text-zinc-700 outline-none focus:border-[#6a12b8] transition-all"
                        >
                        ...
                        <input
                          ...
                          className="w-20 bg-white border border-zinc-200 rounded-lg px-3 py-2 text-xs font-black text-right outline-none focus:border-[#6a12b8] transition-all tabular-nums"
                        />
                        <div className="relative w-28">
                           ...
                           <input
                             ...
                             className="w-full bg-white border border-zinc-200 rounded-lg pl-6 pr-3 py-2 text-xs font-black text-right outline-none focus:border-[#6a12b8] transition-all tabular-nums"
                           />
                        </div>
                        {formItems.length > 1 && (
                          <button 
                  ...
                  <div className="mt-4 pt-4 border-t border-zinc-200 flex justify-between items-center px-1">
                    ...
                    <span className="text-xl font-black text-[#6a12b8] tabular-nums">₱{calculatedTotal.toLocaleString()}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3 px-7 py-5 border-t border-zinc-100 bg-zinc-50/50">
                ...
                <button
                  ...
                  className="flex-1 h-11 bg-[#6a12b8] text-white font-black text-[10px] uppercase tracking-[0.2em] hover:bg-[#2a1647] transition-all disabled:opacity-60 flex items-center justify-center gap-2 rounded-xl shadow-lg shadow-violet-200/50"
                >
          ...
          <div className="relative bg-white rounded-[1.25rem] border border-zinc-200 shadow-2xl w-full max-w-sm flex flex-col overflow-hidden animate-in zoom-in-95 duration-200" style={dashboardFont}>
            ...
            <div className="px-7 pt-6 pb-2">
               <div className="p-3 bg-zinc-50 border border-zinc-100 rounded-xl text-center">
                  ...
                  <p className="text-sm font-black text-[#6a12b8] truncate">{selectedPO.supplier}</p>
               </div>
            </div>
            ...
            <form onSubmit={handleUpdateStatus} className="px-7 py-6 flex flex-col gap-6">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-zinc-200 bg-zinc-50 text-sm font-bold text-[#1a0f2e] outline-none transition-all focus:border-[#6a12b8] focus:bg-white cursor-pointer appearance-none"
                >
