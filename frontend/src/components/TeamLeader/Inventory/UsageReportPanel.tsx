...
const STYLES = `
  ...
  .tl-input-audit:focus { border-color: #6a12b8; box-shadow: 0 0 0 3px rgba(59, 32, 99, 0.05); }
    ...
    <div className="p-8 tl-usage-panel">
      ...
      <div className="mb-8">
        <div className="relative group">
          ...
          <input 
            ...
            className="bg-slate-50 border-none pl-11 pr-4 py-2.5 rounded-xl text-[11px] font-bold outline-none w-full focus:bg-white focus:ring-2 focus:ring-[#6a12b810] transition-all"
          />
        </div>
      </div>
        ...
        {(Object.keys(editBegs).length > 0 || Object.keys(editActuals).length > 0) && (
          <div className="flex items-center gap-4 animate-tl-ready">
            ...
            <button 
              ...
              disabled={saving}
              className="bg-[#6a12b8] text-white px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[0.1em] shadow-lg shadow-[#6a12b820] hover:bg-[#2d1851] disabled:opacity-50 transition-all"
            >
      ...
      <div className="mt-8 tl-card border-slate-100 bg-slate-50/30 p-6">
        <div className="flex items-center gap-2 mb-4">
          <Info size={14} className="text-[#6a12b8]" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-y-6 gap-x-8">
          ...
          <div className="space-y-1">
            <p className="font-black text-[10px] text-[#6a12b8]">SPOIL</p>
          ...
          <div className="space-y-1">
            <p className="font-black text-[10px] text-[#6a12b8]">VAR</p>
