            ...
            <form onSubmit={handleCreatePO} className="p-6 space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 bg-zinc-50 border border-zinc-200 rounded-lg text-xs font-bold text-[#3b2063] outline-none focus:border-[#3b2063]"
              ...
              <button 
                ...
                className="w-full py-3 bg-[#10b981] text-white rounded-lg font-black text-[10px] uppercase tracking-widest shadow-lg hover:bg-[#0da673] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
              >
