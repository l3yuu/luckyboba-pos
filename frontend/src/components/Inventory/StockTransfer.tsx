      ...
      <div className="flex-1 p-6 flex flex-col items-center justify-center">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-zinc-200 w-full max-w-lg">
          ...
          <div className="space-y-4">
             ...
             <button className="w-full bg-[#3b2063] hover:bg-[#2a1745] text-white py-3 rounded-xl font-black uppercase text-xs tracking-widest mt-4 shadow-lg">Initiate Transfer</button>
          </div>
        </div>
      </div>
    </div>
