    ...
    <div className="flex-1 bg-[#f4f5f7] h-full flex flex-col overflow-hidden font-sans">
      ...
      <div className="flex-1 p-6 flex flex-col items-center justify-center">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-zinc-200 w-full max-w-lg">
          <h2 className="text-[#1e40af] font-black text-xs uppercase tracking-[0.2em] mb-6 text-center">Stock Transfer Form</h2>
          <div className="space-y-4">
             ...
             <button className="w-full bg-[#1e40af] text-white py-3 rounded-xl font-black uppercase text-xs tracking-widest mt-4 shadow-lg">Initiate Transfer</button>
          </div>
        </div>
      </div>
    </div>
