...
type Role = 'super_admin' | 'superadmin' | 'system_admin' | 'admin' | 'manager' | 'branch_manager' | 'supervisor' | 'team_leader' | 'cashier' | 'it_admin';
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f6ff]">
        <div className="relative flex flex-col items-center">
          ...
          />
          <div className="w-12 h-12 border-4 border-zinc-200 border-t-[#6a12b8] rounded-full animate-spin" />
