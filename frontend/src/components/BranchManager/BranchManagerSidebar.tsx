...
const BranchManagerSidebar: React.FC<BranchManagerSidebarProps> = ({
  ...
  // Plays exit animation then unmounts the panel
  const closePanel = () => {
    setIsClosing(true);
    setTimeout(() => {
      setIsClosing(false);
  ...
  return (
    <>
      ...
      {/* ════════════════════════════════════════════════
          MOBILE — full-viewport panel (no gap anywhere)
      ════════════════════════════════════════════════ */}
      {(isSidebarOpen || isClosing) && (
        <>
          ...
          {/* Panel — full height & full width, zero gap on all sides */}
          <div
          ...
          >
            ...
            {/* ── Scrollable nav with animated accordions ── */}
            <div className="bm-sb-scroll" style={{ flex: 1, minHeight: 0, padding: '8px 14px' }}>
              ...
              <button onClick={() => toggleGroup('sales')} className="bm-group-btn">
                <span className="bm-item-icon">
                  <BarChart2 size={18} color={salesItems.some(i => isActive(i.tab)) ? '#3b2063' : '#71717a'} />
                </span>
              ...
              <button onClick={() => toggleGroup('menu')} className="bm-group-btn">
                <span className="bm-item-icon">
                  <ShoppingBag size={18} color={menuItems.some(i => isActive(i.tab)) ? '#3b2063' : '#71717a'} />
                </span>
              ...
              <button onClick={() => toggleGroup('inventory')} className="bm-group-btn">
                <span className="bm-item-icon">
                  <Package size={18} color={inventoryItems.some(i => isActive(i.tab)) ? '#3b2063' : '#71717a'} />
                </span>
      ...
      {showLogoutModal && (
        ...
        >
          <div style={{
            ...
            border: '1px solid #e4e4e7', borderRadius: '1.25rem',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', width: '100%', gap: 8 }}>
              <button
                ...
                style={{ width: '100%', padding: '12px', fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#fff', background: '#be2525', border: 'none', borderRadius: '0.625rem', cursor: 'pointer' }}
              >
                Logout
              </button>
              <button
                onClick={() => setShowLogoutModal(false)}
                style={{ width: '100%', padding: '12px', fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#71717a', background: '#fff', border: '1px solid #e4e4e7', borderRadius: '0.625rem', cursor: 'pointer' }}
              >
                Cancel
              </button>
            </div>
