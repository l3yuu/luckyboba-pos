...
const STYLES = `
  ...
  .ir-tab-off:hover { background: #ede8ff; color: #a020f0; }
  ...
  const summaryCards = [
    {
      ...
      iconBg: '#ede9fe', iconColor: '#7c3aed', valueColor: '#a020f0',
    },
    {
            ...
            <div className="flex flex-col lg:flex-row gap-3 items-end">
              ...
              <div className="flex-1 w-full space-y-1.5">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-4 py-3 pr-10 rounded-xl border border-gray-100 bg-[#f5f4f8] font-bold text-[#a020f0] text-xs uppercase tracking-widest outline-none cursor-pointer appearance-none"
                  >
              ...
              <div className="flex gap-2 w-full lg:w-auto">
                ...
                <button
                  ...
                  className="w-11 h-11 rounded-xl bg-white border border-gray-100 text-zinc-400 hover:text-[#a020f0] hover:border-[#ddd6f7] flex items-center justify-center transition-all disabled:opacity-30"
                  ...
                  {data?.items.map((item, idx) => {
                    ...
                    return (
                      <tr key={idx} className="hover:bg-[#f5f4f8] transition-colors group">
                        <td className="px-6 py-3.5">
                          <div className="flex items-center gap-3">
                            <span style={{
                              ...
                              background: idx === 0 ? '#a020f0' : '#f4f4f5',
                            ...
                            <div className="hidden md:flex items-center gap-1.5 w-20">
                              <div className="flex-1 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                <div
                                  ...
                                  style={{ width: `${rowPct}%`, background: idx === 0 ? '#a020f0' : '#d4d4d8' }}
                                />
                              </div>
                        ...
                        <td className="px-6 py-3.5 text-right">
                          <span style={{ fontSize: '0.85rem', fontWeight: 700, color: '#a020f0', letterSpacing: '-0.01em' }}>
