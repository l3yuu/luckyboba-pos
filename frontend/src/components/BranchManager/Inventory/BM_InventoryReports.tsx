    ...
    <div className="p-6 md:p-8 bg-[#f4f2fb] min-h-full">
        ...
        <div className="flex-1 flex flex-col md:flex-row items-center gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0 ml-auto w-full md:w-auto">
            <button onClick={handleExport} disabled={exporting || loading}
              className="w-full md:w-auto bg-[#a020f0] hover:bg-[#2d1851] text-white px-5 py-3 rounded-xl font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all disabled:opacity-50 shadow-sm">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-5">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-100 bg-zinc-50/20">
          ...
          <button onClick={() => setShowGuide(!showGuide)} className="text-[10px] font-bold text-zinc-400 hover:text-[#a020f0] underline">
              ...
              {loading ? <Skeleton /> : filtered.length === 0 ? (
                ...
                return (
                  <tr key={r.id}
                    ...
                    <td className="px-4 py-3.5 text-right text-xs font-medium tabular-nums" style={{ color: r.out > 0 ? '#a020f0' : '#a1a1aa' }}>{r.out}</td>
                    ...
                    <td className="px-4 py-3.5 text-right text-xs font-bold tabular-nums" style={{ color: '#a020f0' }}>{r.usage}</td>
