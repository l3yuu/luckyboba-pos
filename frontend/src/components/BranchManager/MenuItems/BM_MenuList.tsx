        ...
        <div className="flex-1 flex items-center gap-3">
          ...
          <div className="relative shrink-0">
            <select value={filterCat} onChange={e => setFilterCat(e.target.value)}
              className="appearance-none text-xs font-bold text-zinc-600 bg-white border border-zinc-200 rounded-xl pl-4 pr-10 py-3 outline-none focus:ring-2 focus:ring-[#ede8ff] focus:border-[#a020f0] cursor-pointer shadow-sm transition-all hover:bg-zinc-50">
