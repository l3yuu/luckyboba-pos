  ...
  if (loading) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center gap-4 opacity-50">
        <div className="w-12 h-12 border-4 border-[#a020f0] border-t-transparent rounded-full animate-spin" />
        <p className="text-xs font-black uppercase tracking-widest text-[#a020f0]">Syncing Branch Config...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#fafafa] overflow-y-auto">
      ...
      <div className="px-8 py-6 bg-white border-b border-zinc-100 flex items-center justify-between sticky top-0 z-10">
        ...
        <Button onClick={handleSave} disabled={saving} className="rounded-xl h-11 px-8 gap-2 bg-[#a020f0] shadow-lg shadow-violet-100">
