...
const BM_UploadData = ({ onBack }: { onBack: () => void }) => {
  ...
  const btnPrimary = {
    cls:   'flex items-center gap-2 h-9 px-5 bg-[#a020f0] hover:bg-[#2a1647] text-white transition-all rounded-xl active:scale-[0.98] disabled:opacity-50 shadow-sm',
    style: { fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase' } as React.CSSProperties,
  };
  const btnOutline = {
    cls:   'flex items-center gap-2 h-9 px-5 bg-white border border-gray-100 hover:border-[#ddd6f7] text-[#a020f0] transition-all rounded-xl active:scale-[0.98]',
    style: { fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase' } as React.CSSProperties,
  };
          ...
          {(['upload', 'history'] as const).map(tab => (
            <button
              ...
              style={{
                ...
                borderBottom: activeTab === tab ? '2px solid #a020f0' : '2px solid transparent',
              }}
            >
              ...
              <div
                ...
                className={`bg-white border-2 border-dashed rounded-2xl p-12 flex flex-col items-center gap-4 transition-all duration-200 ${
                  selectedFile
                    ...
                    : isDragging
                      ? 'border-[#a020f0] bg-[#faf9ff] scale-[1.01] shadow-md'
                ...
                {selectedFile ? (
                  ...
                  <>
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-colors ${
                      isDragging ? 'bg-[#ede9fe] text-[#a020f0]' : 'bg-gray-50 text-gray-300'
                    }`}>
                      <Upload size={28} strokeWidth={1.5} />
                    </div>
                    <div className="text-center">
                      <p style={{ fontSize: '0.85rem', fontWeight: 700, color: isDragging ? '#a020f0' : '#71717a' }}>
                      ...
                      <tbody>
                        {preview.map((row, idx) => (
                          <tr key={idx} className="border-t border-gray-50 hover:bg-[#faf9ff] transition-colors">
                            <td className="px-5 py-2.5" style={{ fontSize: '0.82rem', fontWeight: 700, color: '#a020f0' }}>{row.name}</td>
            ...
            <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
                <div className="px-6 py-3.5 border-b border-gray-50 flex items-center gap-2">
                  <History size={13} strokeWidth={2.5} className="text-[#a020f0]" />
                    ...
                    {isLoadingHistory ? (
                      <tr>
                        <td colSpan={3} className="p-12 text-center">
                          <Loader2 className="animate-spin mx-auto text-[#a020f0]" size={24} />
                        </td>
                      </tr>
        ...
        <div className="fixed inset-0 z-150 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white w-full max-w-md rounded-2xl border border-gray-100 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between px-7 py-5 border-b border-gray-50">
              <div className="flex items-center gap-2">
                <ClipboardCheck size={15} strokeWidth={2.5} className="text-[#a020f0]" />
                <div>
                  <p className="bm-label" style={{ color: '#a1a1aa' }}>Settings</p>
            ...
            <div className="p-7 space-y-5">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <button onClick={downloadErrorLog}
                      className="flex items-center gap-1 text-[#a020f0] hover:underline transition-colors"
                      style={{ fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
              ...
              <button onClick={() => setSummary(null)}
                className="w-full h-10 bg-[#a020f0] hover:bg-[#2a1647] text-white transition-all rounded-xl active:scale-[0.98]"
