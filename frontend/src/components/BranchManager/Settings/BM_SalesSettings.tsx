...
const BM_SalesSettings = ({ isOpen, onClose }: SalesSettingsProps) => {
  ...
  const btnPrimary = {
    base: 'flex-1 h-10 bg-[#a020f0] hover:bg-[#2a1647] text-white rounded-xl flex items-center justify-center gap-2 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed',
    style: { fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase' } as React.CSSProperties,
  };
  const btnSecondary = {
    base: 'flex-1 h-10 bg-white border border-gray-100 hover:border-[#ddd6f7] text-[#a020f0] rounded-xl flex items-center justify-center gap-2 transition-all active:scale-[0.98]',
    style: { fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase' } as React.CSSProperties,
  };
                  ...
                  <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-3">
                      ...
                      <label key={key} className="flex items-center gap-3 cursor-pointer group">
                        <div
                          ...
                          className={`w-8 h-4 rounded-full transition-all cursor-pointer flex items-center px-0.5 ${
                            formData[key] ? 'bg-[#a020f0]' : 'bg-gray-200'
                          }`}
                        >
                    ...
                    <div className="pt-2 border-t border-gray-50 mt-2 space-y-2 opacity-50">
                       ...
                       <div className="flex items-center gap-2">
                          <Check size={10} className="text-[#a020f0]" />
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-5">
              ...
              <div className="bg-[#faf9ff] border border-gray-100 rounded-2xl p-8 w-full max-w-xs flex flex-col items-center text-center gap-4">
                ...
                <div className="w-full border-t border-dashed border-gray-200 pt-4 space-y-1 text-center">
                  ...
                  <p style={{ fontSize: '0.78rem', fontWeight: 700, color: '#a020f0' }}>luckyboba.franchise@gmail.com</p>
                  <p style={{ fontSize: '0.78rem', fontWeight: 700, color: '#a020f0' }}>09171699894</p>
                </div>
              </div>
            </div>
          </div>
