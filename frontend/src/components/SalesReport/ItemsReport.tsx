          ...
          <div className="bg-white p-6 rounded-4xl shadow-sm border border-zinc-100 mb-6">
            <div className="flex flex-col xl:flex-row gap-4 items-end">
              ...
              <div className="flex-1 w-full">
                ...
                <select value={reportType} onChange={(e) => setReportType(e.target.value)} className="w-full p-3 rounded-xl border-2 border-zinc-100 bg-zinc-50 font-bold text-[#3b2063] outline-none cursor-pointer focus:border-2 focus:border-[#3b2063] focus:ring-2 focus:ring-[#3b2063]/10 transition-all duration-200 appearance-none">
