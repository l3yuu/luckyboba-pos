  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f6ff] p-6 font-sans">
      <div className="bg-white rounded-[2.5rem] shadow-2xl border border-zinc-100 p-10 max-w-md w-full text-center space-y-6">
        ...
        {/* Error Title */}
        <div>
          <h1 className="text-[#a020f0] font-black uppercase text-2xl tracking-tight mb-2">
        ...
        <div className="flex flex-col gap-3 w-full pt-2">
          {onRetry && (
            <button
              onClick={onRetry}
              className="w-full py-4 bg-[#a020f0] text-white rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-[#2a1647] transition-all active:scale-95 shadow-lg shadow-purple-100"
            >
              Try Again
            </button>
          )}
          <button
            ...
            className="w-full py-4 bg-white text-[#a020f0] border-2 border-[#a020f0]/20 rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-[#f0ebff] transition-all active:scale-95"
          >
            Reload Page
          </button>
          <button
