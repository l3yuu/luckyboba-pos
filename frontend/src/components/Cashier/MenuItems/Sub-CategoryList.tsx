            ...
            <div className="px-6 py-4 border-b border-[#e9d5ff] bg-[#f5f0ff] flex flex-col md:flex-row justify-between items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="border border-[#e9d5ff] bg-white px-3 py-1.5 outline-none text-[#1a0f2e] font-semibold text-sm focus:border-[#6a12b8] transition-colors rounded-[0.625rem]"
                >
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="border border-[#e9d5ff] bg-white px-4 py-2 text-sm font-semibold text-[#1a0f2e] outline-none focus:border-[#6a12b8] focus:bg-white w-56 transition-all placeholder:text-zinc-300 rounded-[0.625rem]"
                />
              </div>
            </div>
                    ...
                    {displayData.length > 0 ? displayData.map((sub) => (
                      <tr key={sub.id} className="hover:bg-[#f5f0ff] transition-colors">
                        <td className="px-7 py-3.5">
                          <div className="flex items-center gap-2">
                            <Tag size={13} className="text-[#6a12b8] shrink-0" />
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex flex-wrap gap-1">
                            {(sub.usedBy?.length ?? 0) > 0 ? sub.usedBy.map((cat) => (
                              <span key={cat} className="px-2.5 py-1 bg-[#f5f0ff] border border-[#e9d5ff] text-[10px] font-bold text-[#6a12b8] uppercase tracking-wide rounded-sm">
                                {cat}
                              </span>
                            )) : (
