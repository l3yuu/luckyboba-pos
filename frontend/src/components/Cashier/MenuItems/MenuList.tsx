      ...
      <div className="flex-1 overflow-y-auto p-5 md:p-7 flex flex-col gap-4">
          ...
          <div className="flex flex-col xl:flex-row gap-3 items-end">
            <div className="flex-1 w-full space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-[#e9d5ff] bg-[#f5f0ff] text-[#1a0f2e] font-semibold text-sm outline-none focus:border-[#3b2063] focus:bg-white transition-all placeholder:text-zinc-300 rounded-[0.625rem]"
        ...
        <div className="flex gap-2 items-center">
          <button
            ...
            className="h-9 px-4 bg-white border border-[#e9d5ff] text-zinc-600 font-bold text-[11px] uppercase tracking-widest hover:border-[#3b2063] hover:text-[#3b2063] transition-colors flex items-center gap-2 rounded-[0.625rem]"
          >
          ...
          <div className="h-9 px-4 bg-[#f5f0ff] border border-[#e9d5ff] flex items-center gap-2 rounded-[0.625rem]">
            <Database size={12} className="text-[#3b2063]" />
              ...
              <tbody className="divide-y divide-zinc-100">
                {filteredData.length > 0 ? filteredData.map(item => (
                  <tr key={item.id} className="hover:bg-[#f5f0ff] transition-colors">
                    ...
                    <td className="px-5 py-3.5">
                      <span className="px-2.5 py-1 bg-[#f5f0ff] border border-[#e9d5ff] text-[10px] font-bold text-[#3b2063] uppercase tracking-wide rounded-sm">
