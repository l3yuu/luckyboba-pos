        ...
        <div className="flex items-center gap-2">
          {isOnline && queueCount > 0 && (
            <button
              onClick={syncNow}
              disabled={isSyncing}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[#a020f0] hover:bg-[#6a12b8] text-white text-[10px] font-bold uppercase tracking-widest rounded-lg disabled:opacity-50 transition-all"
            >
