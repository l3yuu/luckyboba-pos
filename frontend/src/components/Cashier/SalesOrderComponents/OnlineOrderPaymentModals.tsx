        ...
        <div className="flex flex-col md:flex-row flex-1 min-h-[50vh] max-h-[85vh] overflow-hidden bg-zinc-50">
          ...
          <div className="flex-1 flex flex-col bg-white border-r border-zinc-200 overflow-hidden">
            ...
            <div className="p-6 bg-[#f5f0ff] shrink-0 border-t border-[#e9d5ff]">
              <div className="space-y-1.5 text-[11px] font-bold text-zinc-600">
                ...
                <div className="flex justify-between font-black text-lg text-[#3b2063] mt-2 pt-2 border-t border-[#e9d5ff]">
                  <span>Total Due</span>
          ...
          <div className="flex-1 flex flex-col bg-white overflow-hidden">
            <div className="flex border-b border-[#e9d5ff] shrink-0 bg-[#f5f0ff] p-2 gap-2">
              <button className="flex-1 py-3 text-sm font-black uppercase tracking-widest rounded-[0.625rem] transition-all border-2 relative bg-[#3b2063] text-white border-[#3b2063] shadow-md">
                Payment
              </button>
            </div>
                  ...
                  {paymentMethod === 'cash' ? (
                    <>
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 mb-4">
                        <button onClick={() => setCashTendered(amtDue)} className="col-span-2 lg:col-span-4 bg-[#3b2063] hover:bg-[#6a12b8] text-white py-2.5 rounded-[0.625rem] font-black text-sm uppercase tracking-widest transition-all shadow-md border-2 border-[#3b2063]">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <input type="text" value={referenceNumber}
                          ...
                          maxLength={13}
                          className="w-full bg-zinc-50 border-2 border-zinc-300 rounded-[0.625rem] py-4 px-5 text-xl font-black outline-none focus:border-[#3b2063] focus:bg-white transition-colors uppercase"
                          placeholder="REF#" />
