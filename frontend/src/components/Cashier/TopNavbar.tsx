          ...
          <div className="absolute right-0 mt-2 w-80 bg-white border border-zinc-200 shadow-xl z-50 overflow-hidden rounded-[0.625rem]">
            ...
            <div className="p-3 bg-zinc-50 border-t border-zinc-100 flex items-center justify-between gap-2">
              ...
              <button
                ...
                className="ml-auto flex items-center gap-1.5 py-2 px-3 bg-white border border-zinc-200 text-[10px] font-bold text-zinc-500 uppercase tracking-widest hover:border-[#7c14d4] hover:text-[#7c14d4] hover:bg-[#f5f0ff] transition-all rounded-[0.625rem] disabled:opacity-40"
              >
