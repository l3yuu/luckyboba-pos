    ...
    <header className="flex-none bg-white border-b border-zinc-200 px-6 py-3.5 flex items-center justify-between z-20 shadow-sm">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex items-center gap-2.5 bg-[#f5f0ff] border border-[#e9d5ff] px-4 py-2.5 rounded-[0.625rem]">
          <div className="w-7 h-7 bg-[#a020f0] flex items-center justify-center shrink-0 rounded-[0.625rem]">
            <Store size={13} className="text-white" strokeWidth={2.5} />
          </div>
          <div>
            <div className="text-[9px] font-bold text-[#a020f0]/50 uppercase tracking-widest leading-none">Branch</div>
            <div className="text-[11px] font-black text-[#a020f0] uppercase leading-tight mt-0.5">{cashierInfo.branch}</div>
          </div>
        </div>
      ...
      <div className="relative" ref={notifRef}>
        <button
          ...
          className={`relative w-10 h-10 flex items-center justify-center border transition-all rounded-[0.625rem] ${
            isNotifOpen
              ...
              : 'bg-zinc-50 border-zinc-200 text-zinc-400 hover:border-[#a020f0] hover:text-[#a020f0] hover:bg-[#f5f0ff]'
          }`}
        >
          {/* Badge dot */}
          {totalCount > 0 && (
        ...
        {isNotifOpen && (
          <div className="absolute right-0 mt-2 w-80 bg-white border border-zinc-200 shadow-xl z-50 overflow-hidden rounded-[0.625rem]">
            ...
            {/* Header */}
            <div className="bg-[#a020f0] px-5 py-4 flex items-center justify-between">
            ...
            <div className="p-3 bg-zinc-50 border-t border-zinc-100 flex items-center justify-between gap-2">
              ...
              <button
                ...
                className="ml-auto flex items-center gap-1.5 py-2 px-3 bg-white border border-zinc-200 text-[10px] font-bold text-zinc-500 uppercase tracking-widest hover:border-[#a020f0] hover:text-[#a020f0] hover:bg-[#f5f0ff] transition-all rounded-[0.625rem] disabled:opacity-40"
              >
