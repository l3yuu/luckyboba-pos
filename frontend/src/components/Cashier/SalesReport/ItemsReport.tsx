            ...
            <div className="flex flex-col lg:flex-row gap-3 items-end">
              ...
              <div className="flex-1 w-full space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-zinc-200 bg-[#f4f2fb] font-semibold text-sm text-[#1a0f2e] outline-none focus:border-[#a020f0] transition-colors"
                />
              </div>
              ...
              <div className="flex-1 w-full space-y-1.5">
                ...
                <div className="relative group">
                  <select
                    ...
                    className="w-full p-3.5 pr-10 rounded-none border border-zinc-200 bg-[#f8f6ff] font-black text-[#a020f0] text-xs uppercase tracking-widest outline-none cursor-pointer appearance-none focus:border-[#a020f0]"
                  >
              ...
              <div className="flex gap-2 w-full lg:w-auto">
                <button
                  ...
                  className="flex-1 lg:w-32 h-11 bg-[#a020f0] hover:bg-[#6a12b8] text-white font-bold text-sm uppercase tracking-widest transition-all disabled:opacity-50 rounded-[0.625rem]"
                >
                  {loading ? 'Loading...' : 'Query'}
                </button>
                <button
                  onClick={generateExcel} disabled={!hasData}
                  className="w-11 h-11 bg-white border border-[#e9d5ff] text-zinc-400 hover:text-[#a020f0] hover:border-[#a020f0] flex items-center justify-center transition-all disabled:opacity-30 rounded-[0.625rem]"
                >
                  <FileDown size={17} />
                </button>
                <button
          ...
          <div className="flex-1 bg-white border border-zinc-200 shadow-sm flex flex-col overflow-hidden relative rounded-[0.625rem]">
            ...
            <div className="px-7 py-5 border-b border-zinc-100 flex justify-between items-center">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 bg-[#a020f0] flex items-center justify-center rounded-sm">
              ...
              <div className="flex items-center gap-6">
                <div className="text-right hidden md:block">
                  ...
                  <p className="text-[10px] font-black text-[#a020f0] uppercase">{data?.cashier_name || 'Terminal Root'}</p>
                </div>
                <div className="bg-white border border-[#e9d5ff] px-4 py-2 flex items-center gap-2 rounded-sm">
                  <Activity size={12} className="text-emerald-500" />
                  <span className="text-[9px] font-black text-[#a020f0] uppercase tracking-widest">{data?.items.length || 0} Records</span>
                </div>
              </div>
            </div>
            ...
            {/* GRAND TOTAL BAR */}
            <div className="bg-[#a020f0] text-white flex justify-between items-center px-8 py-6">
              <div className="flex items-center gap-3">
            ...
            {loading && data && (
              <div className="absolute top-0 left-0 right-0 h-1 bg-purple-200">
                <div className="h-full bg-[#a020f0] animate-pulse" />
              </div>
            )}
          </div>
        </div>
