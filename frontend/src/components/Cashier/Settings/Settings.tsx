...
default:
  return (
    ...
    >
      ...
      >
        <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#3b2063]" />
        <div className="w-14 h-14 rounded-[0.625rem] bg-[#f5f0ff] border border-[#e9d5ff] flex items-center justify-center shrink-0 group-hover:bg-[#3b2063] transition-colors">
          <SettingsIcon size={24} strokeWidth={1.5} className="text-[#3b2063] group-hover:text-white transition-colors" />
        </div>
        ...
        <div className="ml-auto px-3 py-1 rounded-[0.625rem] bg-[#f5f0ff] text-[8px] font-bold text-[#3b2063] uppercase tracking-tighter border border-[#e9d5ff] group-hover:bg-[#3b2063] group-hover:text-white group-hover:border-[#3b2063] transition-colors shrink-0">
          Configure
        </div>
      </button>
      ...
      >
        <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#3b2063]" />
        <div className="w-12 h-12 rounded-[0.625rem] bg-[#f5f0ff] border border-[#e9d5ff] flex items-center justify-center shrink-0 group-hover:bg-[#3b2063] transition-colors">
          <Percent size={20} strokeWidth={1.5} className="text-[#3b2063] group-hover:text-white transition-colors" />
        </div>
        <div className="text-left">
      ...
      >
        <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#3b2063]" />
        <div className="w-12 h-12 rounded-[0.625rem] bg-[#f5f0ff] border border-[#e9d5ff] flex items-center justify-center shrink-0 group-hover:bg-[#3b2063] transition-colors">
          <FileUp size={20} strokeWidth={1.5} className="text-[#3b2063] group-hover:text-white transition-colors" />
        </div>
        <div className="text-left">
      ...
      >
        <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#3b2063]" />
        <div className="w-14 h-14 rounded-[0.625rem] bg-[#f5f0ff] border border-[#e9d5ff] flex items-center justify-center shrink-0 group-hover:bg-[#3b2063] transition-colors">
          <Database size={24} strokeWidth={1.5} className="text-[#3b2063] group-hover:text-white transition-colors" />
        </div>
        <div className="text-left">
          ...
          <div className="flex-1 flex flex-col gap-4" style={{ minHeight: 0 }}>
            ...
            {isAdmin && !activeSubView && (
              <div className="bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff] overflow-hidden w-full shrink-0">
                <div className="bg-[#3b2063] px-7 py-4 border-b border-[#6a12b8]">
                  ...
                  <div className="flex flex-col items-center text-center gap-2 border-x border-[#e9d5ff] px-4">
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="text-[8px] font-bold text-[#3b2063] border border-[#3b2063]/20 px-2 py-0.5 rounded-[0.625rem] hover:bg-[#3b2063] hover:text-white transition-colors"
                      >
                        VIEW LOGS
                      </button>
                    </div>
      ...
      {isLogOpen && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-[0.625rem] border border-[#e9d5ff] shadow-2xl w-full max-w-md flex flex-col overflow-hidden animate-in zoom-in-95 duration-200" style={dashboardFont}>
            <div className="bg-[#3b2063] px-7 py-5 border-b border-[#6a12b8] flex justify-between items-center rounded-t-[0.625rem]">
            ...
            <div className="p-4 bg-[#f5f0ff] border-t border-[#e9d5ff] flex justify-center">
              <button
                ...
                className="h-11 px-7 bg-white border border-[#e9d5ff] text-[#3b2063] rounded-[0.625rem] font-bold text-xs uppercase tracking-widest hover:bg-[#f5f0ff] transition-colors"
              >
                Close
              </button>
            </div>
