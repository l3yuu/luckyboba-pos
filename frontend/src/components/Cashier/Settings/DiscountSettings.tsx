          ...
          <div className="flex-1 bg-white border border-zinc-200 overflow-hidden flex flex-col shadow-sm rounded-[0.625rem]">
            ...
            <div className="px-6 py-4 border-b border-[#e9d5ff] bg-[#f5f0ff] flex flex-col md:flex-row justify-between items-center gap-3 rounded-t-[0.625rem]">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  type="text"
                  className="border border-[#e9d5ff] bg-white px-4 py-2 text-sm outline-none focus:border-[#a020f0] w-56 font-semibold text-[#1c1c1e] rounded-[0.625rem] placeholder:text-zinc-400"
                  value={searchTerm}
                    ...
                    {filteredDiscounts.length > 0 ? filteredDiscounts.map((discount) => (
                      <tr key={discount.id} className="hover:bg-[#f5f0ff] transition-colors">
                        <td className="px-7 py-3.5">
                          <span className="text-[13px] font-extrabold text-[#a020f0]">{discount.name}</span>
                        </td>
              ...
              <div className="flex gap-3">
                {!readOnly && (
                  <button
                    ...
                    className="h-11 px-7 bg-[#a020f0] hover:bg-[#6a12b8] text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm flex items-center gap-2"
                  >
                    + Add Discount
                  </button>
                )}
                <button
                  onClick={onBack}
                  className="h-11 px-7 bg-white border border-[#e9d5ff] text-[#a020f0] font-bold text-xs uppercase tracking-widest hover:bg-[#f5f0ff] transition-colors rounded-[0.625rem] flex items-center gap-2"
                >
