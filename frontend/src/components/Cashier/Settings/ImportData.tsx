...
const ImportData = ({ onBack }: { onBack: () => void }) => {
  ...
  const renderImportCategory = () => (
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      ...
      <div className="bg-white rounded-[0.625rem] shadow-sm border border-zinc-200 p-8 flex flex-col items-center gap-6">
        <div className="w-full max-w-lg border-2 border-dashed border-[#e9d5ff] bg-[#f5f0ff] rounded-[0.625rem] p-10 flex flex-col items-center justify-center text-center gap-3 hover:border-[#7c14d4] hover:bg-[#f5f0ff] transition-all cursor-pointer group">
          <div className="p-4 bg-white rounded-full shadow-sm group-hover:scale-110 transition-transform">
            <Upload size={32} className="text-zinc-400 group-hover:text-[#7c14d4]" />
          </div>
          <div>
        ...
        <div className="w-full max-w-lg">
          <div className="flex items-center gap-2 mb-3">
            <AlertCircle size={14} className="text-[#7c14d4]" />
            <h3 className="text-[10px] font-black text-[#7c14d4] uppercase tracking-[0.2em]">Important Tips: Sample Format CSV</h3>
          </div>
          <div className="border border-[#e9d5ff] rounded-[0.625rem] overflow-hidden">
      ...
      <div className="flex gap-3">
        <button className="h-11 bg-[#7c14d4] hover:bg-[#6a12b8] text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm flex items-center justify-center gap-2 px-6">
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Sub Category</h1>
            <p className="text-zinc-400 font-bold text-xs uppercase tracking-wider mt-1">Upload CSV Data</p>
          </div>
        </div>
      </div>
      <div className="bg-white rounded-[0.625rem] shadow-sm border border-zinc-200 p-8 flex flex-col items-center gap-6">
        <div className="w-full max-w-lg border-2 border-dashed border-[#e9d5ff] bg-[#f5f0ff] rounded-[0.625rem] p-10 flex flex-col items-center justify-center text-center gap-3 hover:border-[#7c14d4] transition-all cursor-pointer group">
          <div className="p-4 bg-white rounded-full shadow-sm group-hover:scale-110 transition-transform">
            <Upload size={32} className="text-zinc-400 group-hover:text-[#7c14d4]" />
          </div>
          <div>
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Inventory Items</h1>
      ...
      <div className="bg-white rounded-[0.625rem] shadow-sm border border-zinc-200 p-8 flex flex-col gap-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-1">
            ...
            <select className="w-full px-4 py-3 bg-[#f5f0ff] border border-[#e9d5ff] rounded-[0.625rem] text-xs font-bold text-slate-700 outline-none focus:border-[#7c14d4] cursor-pointer">
        ...
        <div className="border-2 border-dashed border-[#e9d5ff] bg-[#f5f0ff] rounded-[0.625rem] p-8 flex flex-col items-center justify-center text-center gap-3 hover:border-[#7c14d4] transition-all cursor-pointer group">
          <div className="p-3 bg-white rounded-full shadow-sm group-hover:scale-110 transition-transform">
            <Upload size={24} className="text-zinc-400 group-hover:text-[#7c14d4]" />
          </div>
        ...
        <div className="w-full">
          ...
          <div className="border border-[#e9d5ff] rounded-[0.625rem] overflow-x-auto">
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Food Items</h1>
      ...
      <div className="bg-white rounded-[0.625rem] shadow-sm border border-zinc-200 p-8 flex flex-col gap-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-1">
            <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Items with VAT</label>
            <select className="w-full px-4 py-3 bg-[#f5f0ff] border border-[#e9d5ff] rounded-[0.625rem] text-xs font-bold text-slate-700 outline-none focus:border-[#7c14d4] cursor-pointer">
              <option>VATABLE</option><option>NOT-VATABLE</option>
            </select>
          </div>
          <div className="space-y-1">
            <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Items Active</label>
            <select className="w-full px-4 py-3 bg-[#f5f0ff] border border-[#e9d5ff] rounded-[0.625rem] text-xs font-bold text-slate-700 outline-none focus:border-[#7c14d4] cursor-pointer">
              <option>ACTIVE</option><option>NOT-ACTIVE</option>
            </select>
          </div>
        </div>
        <div className="border-2 border-dashed border-[#e9d5ff] bg-[#f5f0ff] rounded-[0.625rem] p-8 flex flex-col items-center justify-center text-center gap-3 hover:border-[#7c14d4] transition-all cursor-pointer group">
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Quantity</h1>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="border border-[#e9d5ff] rounded-[0.625rem] overflow-hidden">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-zinc-100 bg-white">
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">1234567</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">50</td></tr>
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">2333435</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">10</td></tr>
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">8887688</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">25</td></tr>
              </tbody>
            </table>
          </div>
        </div>
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Item Kits</h1>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="border border-[#e9d5ff] rounded-[0.625rem] overflow-hidden">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-zinc-100 bg-white">
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">1234567</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">5</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">98012345</td></tr>
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">5435543</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">12</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">98012346</td></tr>
              </tbody>
            </table>
          </div>
        </div>
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Update</h1>
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Update Price</h1>
      ...
      <div className="bg-white rounded-[0.625rem] shadow-sm border border-zinc-200 p-8 flex flex-col items-center gap-6">
        ...
        <div className="w-full max-w-lg">
          <div className="flex items-center gap-2 mb-3">
            <AlertCircle size={14} className="text-[#7c14d4]" />
            <h3 className="text-[10px] font-black text-[#7c14d4] uppercase tracking-[0.2em]">IMPORT TIPS: SAMPLE FORMAT CSV</h3>
          </div>
          <div className="border border-[#e9d5ff] rounded-[0.625rem] overflow-hidden">
            <table className="w-full text-left">
              <thead>
              ...
              <tbody className="divide-y divide-zinc-100 bg-white">
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">1234567</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">50</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">75</td></tr>
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">938238</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">40</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">80</td></tr>
              </tbody>
            </table>
          </div>
        </div>
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Customers</h1>
    ...
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-200">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Customers Wallet</h1>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="border border-[#e9d5ff] rounded-[0.625rem] overflow-hidden">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-zinc-100 bg-white">
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">KDE0123</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">1000</td></tr>
                <tr><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">JDE0456</td><td className="px-4 py-2 text-xs font-bold text-slate-500 text-center">1500</td></tr>
              </tbody>
            </table>
          </div>
        </div>
  ...
  const renderMainMenu = () => (
    <div className="flex-1 flex flex-col gap-6 animate-in fade-in duration-200">
      <div className="flex items-center gap-4">
        <button onClick={onBack} className="h-11 bg-white border border-[#e9d5ff] text-[#7c14d4] hover:bg-[#f5f0ff] font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm flex items-center justify-center gap-2 px-6">
          <ArrowLeft size={20} strokeWidth={3} />
        </button>
        <div className="flex items-center gap-3">
          <div className="p-2 bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff]"><FileDown size={24} className="text-[#7c14d4]" /></div>
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">Import Data</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {importActions.map((label, index) => (
          <button
            ...
            className="h-11 bg-white text-[#7c14d4] border border-[#e9d5ff] font-bold text-sm uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm flex items-center justify-center gap-2 px-6 min-h-20 hover:bg-[#f5f0ff] hover:border-[#7c14d4]"
          >
            {label}
          </button>
        ))}
      ...
      <div className="mt-auto bg-white p-4 rounded-[0.625rem] border border-[#e9d5ff] flex items-center gap-3 shadow-sm">
        <div className="p-2 bg-[#f5f0ff] rounded-full text-[#7c14d4]"><Database size={16} /></div>
