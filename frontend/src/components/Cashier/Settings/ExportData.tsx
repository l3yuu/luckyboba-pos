      ...
      <div className="flex-1 bg-[#f4f2fb] h-full flex flex-col overflow-hidden font-sans" style={dashboardFont}>
        <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff] p-6 relative">
            ...
            <div className="flex flex-col md:flex-row items-end gap-4">
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                <div className="flex flex-col gap-1">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-3 border border-[#e9d5ff] bg-[#f5f0ff] rounded-[0.625rem] text-sm font-semibold outline-none focus:border-[#a020f0]"
                    disabled={loading}
                  />
                </div>
                <div className="flex flex-col gap-1">
              ...
              <button 
                ...
                disabled={loading}
                className="w-auto h-11 bg-[#a020f0] hover:bg-[#6a12b8] text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm flex items-center justify-center gap-2 px-6 disabled:opacity-50"
              >
                  ...
                  {group.items.map((item) => {
                    ...
                    return (
                      <button 
                        ...
                        onClick={action}
                        disabled={loading}
                        className="h-11 bg-[#a020f0] hover:bg-[#6a12b8] text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm disabled:opacity-50"
                      >
                        {label}
                      </button>
                    );
          ...
          <div className="mt-auto pt-6 flex justify-start">
            <button 
              onClick={onBack} 
              className="px-6 py-3 h-11 bg-white border border-[#e9d5ff] text-[#a020f0] hover:bg-[#f5f0ff] font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm flex items-center gap-2"
            >
