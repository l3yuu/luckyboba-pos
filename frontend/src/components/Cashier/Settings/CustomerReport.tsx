    ...
    <div className="flex-1 bg-[#f4f2fb] h-full flex flex-col overflow-hidden font-sans">
      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
        <div className="flex justify-between items-end">
          <div>
            <h1 className="text-xl font-black text-[#7c14d4] uppercase tracking-widest">
              LUCKY BOBA MILKTEA
            </h1>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-6 py-2 rounded-[0.625rem] font-black text-[10px] uppercase tracking-widest transition-all ${activeTab === 'CUSTOMER' ? 'bg-[#7c14d4] text-white shadow-md' : 'bg-white text-zinc-400 border border-zinc-200 hover:border-[#7c14d4] hover:text-[#7c14d4]'}`}
            >
              Customer
            </button>
            <button
              onClick={() => setActiveTab('REPORT')}
              className={`px-6 py-2 rounded-[0.625rem] font-black text-[10px] uppercase tracking-widest transition-all ${activeTab === 'REPORT' ? 'bg-[#e9c46a] text-white shadow-md' : 'bg-white text-zinc-400 border border-zinc-200'}`}
            >
              Report
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff] p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[9px] font-black text-zinc-400 uppercase tracking-widest">Total Customers</p>
                <p className="text-xl font-black text-[#7c14d4] mt-1">247</p>
              </div>
              <div className="p-2 bg-[#f5f0ff] rounded-[0.625rem]">
                <div className="w-4 h-4 bg-[#7c14d4] rounded"></div>
              </div>
            </div>
          </div>
          
          <div className="bg-white rounded-[0.625rem] shadow-sm border border-zinc-200 p-4">
            <div className="flex items-center justify-between">
              <div>
              ...
              <div className="p-2 bg-green-100 rounded-[0.625rem]">
          ...
          <div className="bg-white rounded-[0.625rem] shadow-sm border border-[#e9d5ff] p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-black text-[#7c14d4] mt-1">₱156</p>
              </div>
              <div className="p-2 bg-[#f5f0ff] rounded-[0.625rem]">
                <div className="w-4 h-4 bg-[#7c14d4] rounded"></div>
              </div>
          ...
          <div className="bg-white rounded-[0.625rem] shadow-sm border border-zinc-200 p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="p-2 bg-yellow-100 rounded-[0.625rem]">
        ...
        <div className="bg-white rounded-[0.625rem] shadow-sm border border-zinc-200 overflow-hidden flex flex-col flex-1">
          <div className="p-6 border-b border-[#e9d5ff] bg-[#f5f0ff] flex flex-col md:flex-row gap-4 items-end">
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
              <div className="flex flex-col gap-1">
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 bg-white border border-[#e9d5ff] rounded-[0.625rem] text-xs font-bold outline-none focus:border-[#7c14d4]" 
              ...
              <div className="flex flex-col gap-1">
                ...
                <select className="w-full px-4 py-2 bg-white border border-[#e9d5ff] rounded-[0.625rem] text-xs font-bold outline-none focus:border-[#7c14d4]">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <button className="flex-1 md:flex-none px-6 py-2 bg-[#7c14d4] text-white rounded-[0.625rem] font-black uppercase text-[10px] tracking-widest hover:bg-[#6a12b8] flex items-center justify-center gap-2 shadow-md">
                <Search size={14} strokeWidth={3} />Search
              </button>
              <button className="flex-1 md:flex-none px-6 py-2 bg-white border border-[#e9d5ff] text-[#7c14d4] rounded-[0.625rem] font-black uppercase text-[10px] tracking-widest hover:bg-[#f5f0ff] flex items-center justify-center gap-2 shadow-md">
                <Printer size={14} strokeWidth={3} />Print
              </button>
              <button className="flex-1 md:flex-none px-6 py-2 bg-[#10b981] text-white rounded-[0.625rem] font-black uppercase text-[10px] tracking-widest hover:bg-[#059669] flex items-center justify-center gap-2 shadow-md">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-zinc-100">
                {customerReports.map((report, i) => (
                  <tr key={i} className="hover:bg-[#f5f0ff] transition-colors group cursor-pointer">
                    <td className="px-6 py-4 text-xs font-black text-[#7c14d4]">{report.id}</td>
          ...
          <div className="p-4 border-t border-[#e9d5ff] bg-[#f5f0ff] flex justify-between">
            <button 
              onClick={onBack} 
              className="px-6 py-3 bg-white border border-[#e9d5ff] text-[#7c14d4] rounded-[0.625rem] font-black uppercase text-[10px] tracking-widest hover:bg-[#f5f0ff] flex items-center gap-2 shadow-sm transition-all"
            >
            ...
            <div className="flex gap-2">
              <button className="px-6 py-3 bg-[#7c14d4] text-white rounded-[0.625rem] font-black uppercase text-[10px] tracking-widest hover:bg-[#6a12b8] flex items-center gap-2 shadow-lg transition-all">
