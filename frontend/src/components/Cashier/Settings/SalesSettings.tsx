      ...
      <div className="bg-white w-full max-w-4xl rounded-[0.625rem] shadow-2xl overflow-hidden flex flex-col md:flex-row h-[90vh] md:h-auto animate-in zoom-in-95 duration-200 relative">
        ...
        <div className="flex-1 bg-[#f5f0ff] p-8 border-r border-[#e9d5ff] flex flex-col relative overflow-hidden rounded-[0.625rem]">
          <div className="flex-1 flex flex-col animate-in slide-in-from-left-8 duration-300">
            <h2 className="text-[#a020f0] font-black text-xs uppercase tracking-[0.15em] mb-8">Sales Configuration</h2>
            ...
            <div className="mt-8">
              <button
                onClick={onClose}
                className="w-full px-4 py-3 bg-[#a020f0] text-white rounded-[0.625rem] font-black uppercase text-[10px] tracking-widest hover:bg-[#6a12b8] flex items-center justify-center gap-2 shadow-lg transition-all"
              >
        ...
        <div className="flex-1 p-8 bg-white flex flex-col items-center text-center">
          <h2 className="w-full text-left text-[#a020f0] font-black text-xs uppercase tracking-[0.15em] mb-8">Receipt Details</h2>
