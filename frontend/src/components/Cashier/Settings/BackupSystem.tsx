  ...
  return (
    <div className="flex-1 bg-[#f4f2fb] h-full flex flex-col font-sans">
      <div className="p-6 flex flex-col gap-6">
        <div>
          <h1 className="text-xl font-black text-[#6a12b8] uppercase tracking-widest">System Backup</h1>
          {readOnly && (
        ...
        <div className="bg-white p-6 rounded-[0.625rem] border border-[#e9d5ff] flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-[#f5f0ff] rounded-[0.625rem] border border-[#e9d5ff]">
              <Database className="text-[#6a12b8]" size={24} />
            </div>
            <div>
          ...
          {!readOnly && (
            <button
              ...
              className="px-6 py-3 bg-[#6a12b8] text-white rounded-[0.625rem] font-black uppercase text-[10px] tracking-widest flex items-center gap-2 hover:bg-[#6a12b8] transition-all disabled:opacity-50"
            >
        ...
        <button
          onClick={onBack}
          className="w-fit px-6 py-3 bg-white border border-[#e9d5ff] text-[#6a12b8] rounded-[0.625rem] font-black uppercase text-[10px] tracking-widest flex items-center gap-2 hover:bg-[#f5f0ff] transition-colors"
        >
