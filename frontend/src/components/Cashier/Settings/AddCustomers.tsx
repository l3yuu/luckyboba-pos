          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`h-11 px-7 font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm ${!isReport ? 'bg-[#7c14d4] text-white' : 'bg-white border border-zinc-300 text-zinc-500 hover:bg-[#f5f0ff] hover:border-[#7c14d4]'}`}
              >
                Customer
              </button>
              <button
          ...
          <div className="flex-1 bg-white border border-zinc-200 overflow-hidden flex flex-col shadow-sm rounded-[0.625rem]">
            ...
            <div className="px-6 py-4 border-b border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-3 bg-white rounded-[0.625rem]">
              <div className="flex items-center gap-2 text-[10px] font-bold text-zinc-500 uppercase tracking-widest">
                ...
                <input
                  type="text"
                  className="border border-zinc-200 bg-[#f5f0ff] px-4 py-2 text-sm outline-none focus:border-[#7c14d4] w-32 font-semibold text-[#1c1c1e] rounded-[0.625rem] placeholder:text-zinc-400"
                  placeholder="1001"
                />
                <span>Name:</span>
                <input
                  ...
                  className="border border-zinc-200 bg-[#f5f0ff] px-4 py-2 text-sm outline-none focus:border-[#7c14d4] w-48 font-semibold text-[#1c1c1e] rounded-[0.625rem] placeholder:text-zinc-400"
                  placeholder="Search name..."
                />
              </div>
              <div className="flex gap-2">
                <button className="h-11 px-6 bg-[#7c14d4] hover:bg-[#6a12b8] text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm flex items-center gap-2">
                  <Search size={14} strokeWidth={2.5} /> Search
                </button>
                <button className="h-11 px-6 bg-white border border-[#e9d5ff] text-[#7c14d4] hover:bg-[#f5f0ff] hover:border-[#7c14d4] font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] shadow-sm flex items-center gap-2">
            ...
            <div className="px-7 py-4 bg-white border-t border-zinc-100 flex justify-between items-center rounded-[0.625rem]">
              ...
              <div className="flex gap-3">
                <button
                  onClick={onBack}
                  className="h-11 px-7 bg-white border border-zinc-200 text-zinc-500 font-bold text-xs uppercase tracking-widest hover:bg-[#f5f0ff] hover:border-[#7c14d4] hover:text-[#7c14d4] transition-colors rounded-[0.625rem] flex items-center gap-2"
                >
                  <ArrowLeft size={14} strokeWidth={2.5} /> Back
                </button>
                <button
                  onClick={() => setIsAddCustomerModalOpen(true)}
                  className="h-11 px-7 bg-[#7c14d4] hover:bg-[#6a12b8] text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] flex items-center gap-2 shadow-sm"
                >
            ...
            <div className="bg-white rounded-[0.625rem] border border-[#e9d5ff] shadow-2xl w-full max-w-md flex flex-col overflow-hidden animate-in zoom-in-95 duration-200" style={dashboardFont}>
              <div className="flex items-center justify-between px-7 py-5 border-b border-zinc-100 bg-[#7c14d4] rounded-t-[0.625rem]">
                <div>
                  ...
                  <h2 className="text-sm font-extrabold text-white mt-0.5">Add New Customer</h2>
                </div>
                <button onClick={() => setIsAddCustomerModalOpen(false)} className="text-white/70 hover:text-white transition-colors p-1 text-lg leading-none">×</button>
              </div>

              <div className="px-7 py-6 flex flex-col gap-5">
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block">Card Number</label>
                  <input type="text" className="w-full px-4 py-3 rounded-[0.625rem] border border-zinc-200 bg-[#f5f0ff] text-sm font-semibold outline-none transition-all text-[#1c1c1e] placeholder:text-zinc-400 focus:border-[#7c14d4] focus:bg-white" placeholder="Enter card number" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block">Full Name</label>
                  <input type="text" className="w-full px-4 py-3 rounded-[0.625rem] border border-zinc-200 bg-[#f5f0ff] text-sm font-semibold outline-none transition-all text-[#1c1c1e] placeholder:text-zinc-400 focus:border-[#7c14d4] focus:bg-white" placeholder="Enter customer name" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block">Email</label>
                  <input type="email" className="w-full px-4 py-3 rounded-[0.625rem] border border-zinc-200 bg-[#f5f0ff] text-sm font-semibold outline-none transition-all text-[#1c1c1e] placeholder:text-zinc-400 focus:border-[#7c14d4] focus:bg-white" placeholder="Enter email address" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block">Phone Number</label>
                  <input type="tel" className="w-full px-4 py-3 rounded-[0.625rem] border border-zinc-200 bg-[#f5f0ff] text-sm font-semibold outline-none transition-all text-[#1c1c1e] placeholder:text-zinc-400 focus:border-[#7c14d4] focus:bg-white" placeholder="Enter phone number" />
                </div>
              </div>
              ...
              <div className="flex gap-3 px-7 py-5 border-t border-zinc-100">
                ...
                <button
                  className="flex-1 h-11 bg-[#7c14d4] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#6a12b8] transition-all rounded-[0.625rem]"
                >
                  Add Customer
                </button>
              </div>
