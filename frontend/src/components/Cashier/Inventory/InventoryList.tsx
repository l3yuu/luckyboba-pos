        ...
        <div className="flex-1 bg-[#f4f2fb] h-full flex flex-col overflow-hidden font-sans" style={dashboardFont}>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#6a12b8] mx-auto mb-4"></div>
        ...
        <div className="flex-1 overflow-y-auto p-5 md:p-7 flex flex-col gap-4">
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-white border border-[#e9d5ff] rounded-[0.625rem] px-12 py-3 text-sm font-bold text-[#1c1c1e] outline-none focus:border-[#6a12b8] transition-all shadow-sm placeholder:text-zinc-400"
            />
            ...
            <div className="bg-white rounded-[0.625rem] border border-[#e9d5ff] shadow-2xl w-full max-w-md flex flex-col overflow-hidden animate-in zoom-in-95 duration-200" style={dashboardFont}>
              ...
              <div className="px-7 py-6 flex flex-col gap-5">
                <div className="space-y-1.5">
                  ...
                  <div className="text-xs text-zinc-400">Current Stock: <span className="font-bold text-[#6a12b8]">{selectedItem?.quantity}</span></div>
                </div>
                <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-[0.625rem] border border-[#e9d5ff] text-sm font-semibold outline-none transition-all bg-white text-[#1c1c1e] focus:border-[#6a12b8] focus:bg-white"
                      min="0"
                    />
                  </div>
                  <div className="space-y-1.5">
