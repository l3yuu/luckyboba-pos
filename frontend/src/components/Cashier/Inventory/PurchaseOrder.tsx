              ...
              <tbody className="divide-y divide-zinc-100">
                {orders.length > 0 ? orders.map((po) => (
                  <tr key={po.id} className="hover:bg-[#f5f0ff] transition-colors">
                    ...
                    <td className="px-7 py-3.5">
                      <span className="text-[13px] font-extrabold text-[#a020f0]">{po.supplier}</span>
                    </td>
                    <td className="px-7 py-3.5">
              ...
              <div className="px-7 py-6 flex flex-col gap-5">
                ...
                <div className="border border-[#e9d5ff] rounded-[0.625rem] p-4 bg-[#f5f0ff]">
                    ...
                    {formItems.map((item, index) => (
                      <div key={index} className="flex gap-2 items-center">
                        <select
                          ...
                          className="flex-1 bg-white border border-[#e9d5ff] rounded-[0.625rem] px-3 py-2 text-xs font-semibold text-[#1c1c1e] outline-none focus:border-[#a020f0]"
                        >
                        ...
                        <input
                          ...
                          className="w-20 bg-white border border-[#e9d5ff] rounded-[0.625rem] px-3 py-2 text-xs font-semibold text-[#1c1c1e] outline-none focus:border-[#a020f0]"
                        />
                        <input
                          ...
                          className="w-24 bg-white border border-[#e9d5ff] rounded-[0.625rem] px-3 py-2 text-xs font-semibold text-[#1c1c1e] outline-none focus:border-[#a020f0]"
                        />
                        {formItems.length > 1 && (
                  ...
                  <div className="mt-4 pt-4 border-t border-[#e9d5ff] flex justify-between items-center">
                    ...
                    <span className="text-lg font-extrabold text-[#a020f0]">₱{calculatedTotal.toLocaleString()}</span>
                  </div>
                </div>
              </div>
