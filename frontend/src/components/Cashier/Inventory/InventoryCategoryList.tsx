        ...
        <div className="px-7 py-6 flex flex-col gap-5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-[0.625rem] border border-[#e9d5ff] text-sm font-semibold outline-none transition-all bg-white text-[#1c1c1e] placeholder:text-zinc-400 focus:border-[#6a12b8] h-24 resize-none"
    ...
    <div ref={overlayRef} onClick={handleBackdropClick} className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-[0.625rem] border border-[#e9d5ff] shadow-2xl w-full max-w-sm flex flex-col overflow-hidden" style={dashboardFont}>
        ...
        <div className="px-7 py-7 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm font-bold text-[#1c1c1e]">Delete <span className="text-[#6a12b8]">"{category.name}"</span>?</p>
        ...
        <div className="flex-1 overflow-y-auto p-5 md:p-7 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="h-11 px-7 bg-[#6a12b8] hover:bg-[#6a12b8] text-white font-bold text-xs uppercase tracking-widest flex items-center gap-2 transition-colors rounded-[0.625rem] shadow-sm"
            >
            ...
            <div className="px-6 py-4 border-b border-[#e9d5ff] bg-[#f5f0ff] flex flex-col md:flex-row justify-between items-center gap-3">
              <div className="flex items-center gap-2 text-[10px] font-bold text-zinc-500 uppercase tracking-widest">
                ...
                <select
                  ...
                  className="border border-[#e9d5ff] bg-white px-2 py-1.5 outline-none text-[#1c1c1e] font-semibold text-xs rounded-[0.625rem] focus:border-[#6a12b8]"
                >
                    ...
                    {displayData.length > 0 ? displayData.map((cat) => (
                      <tr key={cat.id} className="hover:bg-[#f5f0ff] transition-colors">
                        <td className="px-7 py-3.5">
                          <span className="text-[13px] font-extrabold text-[#6a12b8]">{cat.name}</span>
                        </td>
