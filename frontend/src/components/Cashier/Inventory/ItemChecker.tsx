    ...
    <>
      ...
      <div className="flex-1 bg-[#f4f2fb] h-full flex flex-col overflow-hidden font-sans" style={dashboardFont}>
        ...
        <div className="flex-1 p-5 md:p-7 flex flex-col items-center justify-center gap-4">
          ...
          {/* SCANNER INPUT */}
          <div className="bg-white p-8 rounded-[0.625rem] shadow-sm border border-[#e9d5ff] w-full max-w-md text-center">
            ...
            <form onSubmit={handleCheck}>
              <input
                ...
                className="w-full px-4 py-4 rounded-[0.625rem] border border-[#e9d5ff] text-sm font-semibold outline-none transition-all bg-white text-[#1c1c1e] placeholder:text-zinc-400 focus:border-[#6a12b8] focus:bg-white text-center mb-4"
                placeholder="00000000"
              />
              <button
                type="submit"
                disabled={loading}
                className="w-full h-11 bg-[#6a12b8] hover:bg-[#6a12b8] text-white font-bold text-xs uppercase tracking-widest transition-colors rounded-[0.625rem] disabled:opacity-50"
              >
          ...
          {item && (
            <div className="w-full max-w-md bg-white rounded-[0.625rem] shadow-xl border-4 border-emerald-500 overflow-hidden animate-in zoom-in duration-300">
              ...
              <div className="p-8 text-center space-y-4">
                <h3 className="text-2xl font-extrabold text-[#6a12b8] uppercase leading-tight">{item.name}</h3>
