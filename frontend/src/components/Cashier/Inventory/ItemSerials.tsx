        ...
        <div className="flex-1 overflow-y-auto p-5 md:p-7 flex flex-col gap-4">
          ...
          <div className="bg-white border border-[#e9d5ff] p-4 rounded-[0.625rem] shadow-sm flex gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 bg-[#f5f0ff] border border-[#e9d5ff] rounded-[0.625rem] text-sm font-semibold outline-none focus:border-[#7c14d4] placeholder:text-zinc-400"
            />
            <select
              value={statusFilter}
              onChange={(e) => setStatusFilter(e.target.value)}
              className="px-4 py-3 bg-[#f5f0ff] border border-[#e9d5ff] rounded-[0.625rem] text-sm font-semibold outline-none cursor-pointer focus:border-[#7c14d4]"
            >
                  ...
                  serials.map((record) => (
                    <tr key={record.id} className="hover:bg-[#f5f0ff] transition-colors">
                      <td className="px-7 py-3.5">
                        <span className="text-[13px] font-extrabold text-[#7c14d4] uppercase tracking-tight">{record.itemName}</span>
                      </td>
                      <td className="px-7 py-3.5">
            ...
            <form onSubmit={handleRegister} className="px-7 py-6 flex flex-col gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-[0.625rem] border border-[#e9d5ff] text-sm font-semibold outline-none transition-all bg-white text-[#1c1c1e] placeholder:text-zinc-400 focus:border-[#7c14d4] focus:bg-white font-mono"
