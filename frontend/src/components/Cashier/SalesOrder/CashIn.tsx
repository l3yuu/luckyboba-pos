          ...
          <div className="relative w-full max-w-xl h-120" style={{ perspective: '1200px' }}>
            ...
            >
              ...
              <div className="absolute w-full h-full bg-white border border-[#e9d5ff] p-8 flex flex-col rounded-[0.625rem]" style={{ backfaceVisibility: 'hidden' }}>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full text-black font-bold text-4xl pl-14 pr-5 py-5 border outline-none tabular-nums transition-all ${
                          isEodLocked
                            ? 'bg-[#f5f0ff] border-[#e9d5ff] text-[#a020f0]/50'
                ...
                {/* ── Preparing overlay ── */}
                {isPreparing ? (
                  <div className="mt-6 rounded-[0.625rem] bg-[#f5f0ff] border-2 border-[#a020f0]/20 p-5 space-y-3">
                    <div className="flex items-center justify-between">
                      <p className="text-[11px] font-black uppercase tracking-[0.18em] text-[#a020f0]">
                        {prepLabel}
                      </p>
                      <span className="text-[11px] font-black text-[#a020f0] tabular-nums">{prepProgress}%</span>
                    </div>
                    <div className="w-full bg-zinc-200 rounded-full h-2 overflow-hidden">
                      <div
                        className="h-2 rounded-full bg-[#a020f0] transition-all duration-150 ease-out"
              ...
              <div
                className="absolute w-full h-full bg-white border border-[#a020f0] p-10 flex flex-col rounded-[0.625rem]"
                style={{ backfaceVisibility: 'hidden', transform: 'rotateY(180deg)' }}
              >
                <div className="text-center border-b-2 border-dashed border-[#a020f0] pb-6">
          ...
          <div className="bg-white w-full max-w-sm border border-[#e9d5ff] p-7 flex flex-col gap-5 shadow-sm rounded-[0.625rem]">
            <div className="flex items-center gap-3 pb-4 border-b border-[#e9d5ff]">
              <div className="w-9 h-9 bg-[#f5f0ff] border border-[#e9d5ff] flex items-center justify-center">
                <Printer size={17} className="text-[#a020f0]" />
              </div>
              <div>
            ...
            <button
              ...
              className={`w-full py-4 font-bold text-sm uppercase tracking-widest flex items-center justify-center gap-3 transition-all ${
                isFlipped
                  ? 'bg-[#a020f0] hover:bg-[#6a12b8] text-white'
                  : 'bg-white border border-[#e9d5ff] text-black hover:bg-[#f5f0ff] hover:border-[#a020f0] cursor-not-allowed'
              }`}
            >
              <Printer size={16} />
              Print Receipt
