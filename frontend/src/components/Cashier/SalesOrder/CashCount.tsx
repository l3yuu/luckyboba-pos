      ...
      {isLoading && (
        <div className="fixed inset-0 z-9999 flex items-center justify-center bg-white/90 backdrop-blur-sm">
          <div className="bg-white px-12 py-10 border border-[#e9d5ff] flex flex-col items-center gap-5 shadow-2xl rounded-[0.625rem]">
            <RefreshCw className="w-10 h-10 text-[#6a12b8] animate-spin" strokeWidth={1.5} />
                      ...
                      <input
                        ...
                        className={`w-full text-center font-bold text-sm py-2 border outline-none transition-all tabular-nums ${
                          (isEodLocked || latestTx !== null)
                            ...
                            : 'bg-[#f5f0ff] border-zinc-200 focus:border-[#6a12b8] focus:bg-white'
                        }`}
                      />
                    </div>
                    {/* FIXED: removed stray > */}
            ...
            <div className="p-6 border-t border-zinc-100 space-y-4 bg-white">
              ...
              {!latestTx && !isEodLocked ? (
                <button
                  ...
                  className="w-full py-4 bg-[#6a12b8] hover:bg-[#6a12b8] text-white font-bold text-sm uppercase tracking-widest flex items-center justify-center gap-2 transition-all active:scale-[0.99] disabled:opacity-50 rounded-[0.625rem]"
                >
                ...
                <button
                  ...
                  className={`w-full py-4 font-bold text-sm uppercase tracking-widest flex items-center justify-center gap-2 transition-all rounded-[0.625rem] ${
                    isEodLocked
                      ...
                      : 'bg-white border border-[#6a12b8] text-[#6a12b8] hover:bg-[#f4f2fb] active:scale-[0.99]'
                  }`}
                >
                  <RefreshCw size={16} />
