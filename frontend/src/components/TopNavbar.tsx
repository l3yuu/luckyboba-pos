...
// Define the interface to accept the lock status from parent components
      ...
      <div className="relative" ref={notifRef}>
        ...
        {isNotifOpen && (
          <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl shadow-xl border border-zinc-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="bg-[#3b2063] px-4 py-3">
              <p className="text-white text-[10px] font-bold uppercase tracking-widest">Notifications</p>
            </div>
            <div className="max-h-64 overflow-y-auto">
              ...
              {isEodLocked && (
                <div className="p-4 border-b border-zinc-50 bg-red-50/30">
                  <p className="text-red-600 font-bold text-xs mb-1">System Status</p>
                  <p className="text-zinc-500 text-[10px]">End of Day count has been submitted.</p>
                </div>
              )}
            </div>
          </div>
